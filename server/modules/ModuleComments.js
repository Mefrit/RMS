    ...
    actionGetComments(post_data) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                console.log("post_data comments", post_data, "SELECT question,time_receipt FROM Comments WHERE id_question=" + post_data.id_question);
                const comments = yield this.makeRequestToDb(database, "SELECT comment, id_comment FROM Comments WHERE id_question=" + post_data.id_question);
                this.getCisBd();
                const question = "";
